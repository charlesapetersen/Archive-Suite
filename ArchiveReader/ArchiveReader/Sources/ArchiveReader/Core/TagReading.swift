...
/// destroying subject/date/priority tags. (Safety Protocol §3.) `TagWriter` will refuse to write on
/// `.failure`.
enum TagReadResult: Sendable, Equatable {
...
enum TagReading {
    ...
    static func read(_ url: URL) -> TagReadResult {
        do {
    ...
    static func readTags(_ url: URL) -> DocumentTags? {
