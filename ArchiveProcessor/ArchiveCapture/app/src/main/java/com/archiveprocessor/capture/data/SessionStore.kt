...
class SessionStore internal constructor(
    ...
    data class EndedSeg(val group: String, val quality: String?, val year: Int?, val month: Int?,
        ...
        val published = try {
            ...
            for (it in items) {
                arr.put(JSONObject().apply {
                    ...
                    it.quality?.let { v -> put("quality", v) }
            ...
            for (i in 0 until arr.length()) {
                ...
                items.add(
                    CapturedItem(
                        ...
                        quality = if (o.has("quality")) o.getString("quality") else null,
