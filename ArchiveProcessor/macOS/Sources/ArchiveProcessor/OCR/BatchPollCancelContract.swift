...
///   * This says nothing about whether the operator SEES the kept-journal warning — `cancel()` assigns it
///     and the unwinding poll writes its own `statusMessage` on the way out, which is the open W16.bat6.
